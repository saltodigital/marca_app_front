        ...
        <el-form label-position="top" :model="persona" :rules="personaRules" ref="formPersona">
          ...
          <el-col :xs="24" :sm="6">
            <el-form-item label="Fecha de Nacimiento" class="fluid-width" prop="fechaNacimiento">
              <el-date-picker v-model="persona.fechaNacimiento" type="date" format="dd-MM-yyyy" placeholder="Seleccione">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="6">
      ...
      <el-form label-position="top">
        ...
        <el-col :xs="24" :sm="5">
          <el-form-item label="Días">
            <el-select v-model="client_horario.dias" multiple collapse-tags placeholder="Seleccione">
